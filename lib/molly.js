(function() {
  this.molly = function(constructor) {
    var add_leading_slash, events, exports, parse_url, replace_url_arguments;
    events = molly.events;
    ...
    return exports = {
      ...
      trigger: function(path) {
        ...
        for (event in events) {
          ...
          _results.push((args != null ? args[0] : void 0) === path ? callback.apply(this, args.slice(1, (args.length + 1) || 9e9)) : void 0);
        }
        return _results;
      }
    };
