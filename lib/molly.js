(function() {
  this.molly = function(constructor) {
    ...
    parse_url = function(str) {
      return add_leading_slash(replace_url_arguments(str));
    };
    exports = {
      route: function() {
    ...
    return exports = {
      ...
      trigger: function(path) {
        ...
        for (event in events) {
          ...
          _results.push((args != null ? args.length : void 0) ? callback.apply(this, args.slice(1, (args.length + 1) || 9e9)) : void 0);
        }
        return _results;
      }
    };
